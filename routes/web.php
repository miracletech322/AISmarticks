...
Route::get('/users/advanced-profile/{id}', 'UsersController@advancedProfile')->name('users.advanced_profile');
Route::post('/users/advanced-profile/{id}', 'UsersController@advancedProfileSave')->name('users.advanced_profile.save');
...
Route::post('/conversation/get-template', ['uses' => 'ConversationsController@getWhatsappTemplate', 'laroute' => true])->name('conversations.get_whatsapp_template');
...
// Billing and License
//Route::get('/billing-license', ['uses' => 'BillingLicenseController@view', 'laroute' => true])->name('billing_license.view');
