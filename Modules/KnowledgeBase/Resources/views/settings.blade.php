        ...
        <form class="form-horizontal margin-top margin-bottom-30" method="POST" action="" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <p class="form-help">
                        ...
                        <br/>
                        <strong>{{ __('Example') }}</strong>: [Contact Us](https://demo.smarticks.com/chat/widget/form/2312787837)
                    </p>
                </div>
            </div>
            ...
            <div id="kb-widget-form">
                ...
                <div class="form-group @if (empty($widget_settings)) hidden @endif" id="kb-widget-code-wrapper">
                    ...
                    <div class="col-sm-6 col-sm-offset-2">
                        <textarea rows="5" readonly class="disabled form-control" id="kb-widget-code">&lt;!-- Smarticks BEGIN --&gt;
&lt;script&gt;var SmarticksW={s:{{ \Helper::jsonEncodeUtf8($widget_settings) }}{{ '}' }};(function(d,e,s){if(d.getElementById(&quot;smarticks-w&quot;))return;a=d.createElement(e);m=d.getElementsByTagName(e)[0];a.async=1;a.id=&quot;smarticks-w&quot;;a.src=s;m.parentNode.insertBefore(a, m)})(document,&quot;script&quot;,&quot;{{ \Kb::getWidgetScriptUrl($mailbox->id, true) }}&quot;);&lt;/script&gt;
&lt;!-- Smarticks END --&gt;</textarea>
                        ...
                        @if (!strstr(config('app.url'), 'https:'))
                            <p class="text-warning">
                                {{ __("If you are embedding the contact form widget on HTTPS website, your Smarticks must also use HTTPS.") }}
                            </p>
                        @endif
                        <p class="text-help">
