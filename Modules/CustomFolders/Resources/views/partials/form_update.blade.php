...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input class="form-control" name="name" value="{{ $folder->meta['name'] ?? '' }}" maxlength="20" required/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <label class="checkbox" for="unassigned">
            <input type="checkbox" name="unassigned" value="1" id="unassigned" @if (!empty($folder->meta['unassigned'])) checked @endif />{{ __('Show unassigned tickets only') }}
        </label>
    </div>
</div>
<hr/>
