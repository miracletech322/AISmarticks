            ...
            case 'update':
                ...
                if (!$response['msg']) {
                    ...
                    if (!$response['msg']) {
                        ...
                        $prev_meta_unassigned = isset($folder->meta['unassigned']) ? $folder->meta['unassigned'] : null;
                        ...
                        $meta['unassigned'] = $request->unassigned ?? '';
                        ...
                        if (
                        	...
                        	|| $prev_meta_unassigned != $folder->meta['unassigned']
                        ) {
