...
Route::group(['middleware' => 'web', 'prefix' => \Helper::getSubdirectory(), 'namespace' => 'Modules\ExtendedAttachments\Http\Controllers'], function()
{
    ...
    Route::get('/attachments/eml_viewer', ['uses' => 'ExtendedAttachmentsController@emlViewer', 'middleware' => ['auth', 'roles'], 'roles' => ['user', 'admin'], 'laroute' => true])->name('extendedattachments.eml_viewer');
});
