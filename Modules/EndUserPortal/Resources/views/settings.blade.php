    ...
    <div class="col-xs-12">
        <form class="form-horizontal margin-top margin-bottom" method="POST" action="" autocomplete="off" id="eup-widget-form">
            ...
            <div class="form-group @if (empty($widget_settings)) hidden @endif" id="eup-widget-code-wrapper">
                ...
                <div class="col-sm-6 col-sm-offset-2">
                    <textarea rows="5" readonly class="disabled form-control" id="eup-widget-code">&lt;!-- Smarticks BEGIN --&gt;
&lt;script&gt;var SmarticksW={s:{{ \Helper::jsonEncodeUtf8($widget_settings) }}@if ($prefill_test),f:{{ \Helper::jsonEncodeUtf8($prefill_test) }}@endif{{ '}' }};(function(d,e,s){if(d.getElementById(&quot;smarticks-w&quot;))return;a=d.createElement(e);m=d.getElementsByTagName(e)[0];a.async=1;a.id=&quot;smarticks-w&quot;;a.src=s;m.parentNode.insertBefore(a, m)})(document,&quot;script&quot;,&quot;{{ \EndUserPortal::getWidgetScriptUrl($mailbox->id, true) }}&quot;);&lt;/script&gt;
