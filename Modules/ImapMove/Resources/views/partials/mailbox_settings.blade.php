<div>
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
                <label for="imapmove_action_{{ \ImapMove::ACTION_MOVE }}" class="radio inline"><input type="radio" name="imapmove_action" value="{{ \ImapMove::ACTION_MOVE }}" id="imapmove_action_{{ \ImapMove::ACTION_MOVE }}" @if ($imapmove_action == \ImapMove::ACTION_MOVE)checked="checked"@endif> {{ __('Move to IMAP folder') }} + {{ __('Mark email as read') }}</label>
            </div>
