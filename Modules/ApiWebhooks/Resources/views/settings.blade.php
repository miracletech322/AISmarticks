<form class="form-horizontal margin-top margin-bottom" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <a href="https://smarticks.com/api-docs/" target="_blank">{{ __('API Documentation') }}</a>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <p class="form-help">
                ...
                <a href="#apiwh-cors-example" data-toggle="collapse">{{ __('Examples') }} <span class="caret"></span></a><div id="apiwh-cors-example" class="collapse text-help">
                ● * – {{ __('any host') }}<br/>
