...
class ApiController extends Controller
{
    ...
    {
        $data = $request->all();
		error_log('CREATE CONVERSATION REQUEST = '.json_encode($data));
    ...
    public function updateCustomer(Request $request, $customerId)
    {
        ...
        $data = $request->all();
        error_log('UPDATE CUSTOMER DATA = '.json_encode($data));
        $data = self::toSnake($data);
        $data = self::convertCustomerCodes($data);
    ...
    {
        $data = $request->all();
		error_log('API CUSTOMER FIELDS = '.json_encode($data));
    ...
    {
        $data = $request->all();
		error_log('WEBHOOK create data = '.json_encode($data));
