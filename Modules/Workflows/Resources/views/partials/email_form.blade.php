    ...
    <form class="form-horizontal wf-email-form @if (!empty($is_note)) conv-note-block @endif" method="POST" action="">
        ...
        @if (!in_array('cc', $exclude_fields ?? []))
            <div class="form-group wf-email-form-cc">
                ...
                <div class="conv-reply-field">
                    <input class="form-control wf-email-input" type="text" value="" name="cc" placeholder="{{ __('(optional)') }}" />
                </div>
            </div>
        @endif
        @if (!in_array('bcc', $exclude_fields ?? []))
            <div class="form-group wf-email-form-bcc">
                ...
                <div class="conv-reply-field">
                    <input class="form-control wf-email-input" type="text" value="" name="bcc" placeholder="{{ __('(optional)') }}" />
                </div>
            </div>
        @endif
        @if (!in_array('subject', $exclude_fields ?? []))
            <div class="form-group wf-email-form-subject">
                <label class="control-label conv-reply-label">{{ __('Subject') }}</label>
                <div class="conv-reply-field">
                    <input class="form-control wf-email-input" type="text" value="" name="subject" placeholder="{{ __('(optional)') }}" />
                </div>
            </div>
        @endif
