                ...
                <div class="small margin-bottom-10">
                    ...
                    <span class="translation-triggers">
                        <?php foreach ($translations['i18n'] as $locale => $text): ?>
                            ...
                            <a href="#" data-thread-id="<?php echo $thread->id ?>" data-locale="<?php echo $locale ?>" class="ttr-toggle translation-trigger-<?php echo $locale ?> <?php if ($is_current): ?> selected<?php endif ?>"><?php echo \Helper::$locales[$locale]['name_en'] ?><span style="margin-left: 3px;" class="caret <?php if (!$is_current): ?>hidden<?php endif ?>"></span></a> <?php if ($i < count($translations['i18n'])-1): ?>&nbsp;|&nbsp;<?php endif ?>
                            <?php $i++; ?>
                        <?php endforeach ?>
                    </span>
                </div>
