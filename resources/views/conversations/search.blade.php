...
@section('content')
	...
	<div class="search-results">
		...
		@if ($mode == App\Conversation::SEARCH_MODE_CONV)
	    	@include('conversations/conversations_table', ['mailbox' => $search_mailbox, 'params' => ['target_blank' => \Auth::user()->open_on_this_page ? '_self' : '_blank', 'show_mailbox' => (count(Auth::user()->mailboxesCanView(true)) > 1)]])
	    @else
