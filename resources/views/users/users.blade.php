...
<div class="container">
    <div class="flexy-container">
        ...
        <div class="flexy-item" style="margin-left: 10px;margin-top: 10px;">
            <p>You currently have {{ $usersCount }} users and {{ $adminsCount }} admins.</p>
        </div>
...
{{--    <div class="flexy-container">--}}
{{--        <div class="flexy-item" style="margin-top: 5px;">--}}
{{--            <p>You currently have {{ 1 }} users and {{ 2 }} admins.</p>--}}
{{--        </div>--}}
{{--    </div>--}}
