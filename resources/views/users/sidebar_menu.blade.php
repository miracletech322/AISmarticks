...
<ul class="sidebar-menu">
	...
	<li @if (Route::currentRouteName() == 'users.advanced_profile')class="active"@endif><a href="{{ route('users.advanced_profile', ['id'=>$user->id]) }}"><i class="glyphicon glyphicon-cog"></i> {{ __('Advanced profile') }}</a></li>
