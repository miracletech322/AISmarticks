                    ...
                    <div class="collapse navbar-collapse" id="app-navbar-collapse">
                                ...
                                <li class="dropdown {{ \App\Misc\Helper::menuSelectedHtml('manage') }}">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @if (Auth::user()->isAdmin())
                                            ...
                                            <li class="{{ \App\Misc\Helper::menuSelectedHtml('billing-license') }}"><a href="{{ route('billing_license', ['section' => 'license-subscription']) }}">{{ __('Billing and License') }}</a></li>
                                        @endif
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            @else
								...
								<!-- Added by Misha -->
								<!-- <li style="display:flex!important; align-items:center!important; height:50px;">
									@php
										$dropdown_locales = config('app.locales');
									@endphp
									<div style="padding-right:10px; padding-left:10px;">
										<select id="change_locale" class="form-control" style="max-width:100px;">
											@foreach ($dropdown_locales as $locale)
												@php
													$data = \Helper::getLocaleData($locale);
												@endphp
												<option value="{{ $locale }}" @if (Auth::user()->getLocale() == $locale)selected="selected"@endif>{{ $data['name'] }}</option>
											@endforeach
										</select>
									</div>
								</li> -->
								<!-- End of added by Misha -->
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-with-icons">
                                        <li>
                                            <form class="form-inline form-nav-search" role="form" action="{{ route('conversations.search') }}" target="{{ $target_blank }}">
